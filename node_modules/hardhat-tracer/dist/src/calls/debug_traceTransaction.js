...
async function getCalls(txHash, network) {
...
async function parseGanacheStructLogs(txHash, network, structLogs) {
    var _a;
    ...
    let call = {
        type: "CALL",
        from: r.from,
        to: (_a = r.to) !== null && _a !== void 0 ? _a : ethers_1.ethers.constants.AddressZero,
        value: r.value,
        gas: r.gas,
        gasUsed: r.gasUsed,
        input: tx.input,
    ...
    if (call.to === ethers_1.ethers.constants.AddressZero && r.contractAddress) {
        call.type = "CREATE";
    ...
    structLogs.forEach((log) => {
        ...
        if (isSysOp && log.op == "SELFDESTRUCT") {
            ...
            (_a = callstack[left - 1].calls) === null || _a === void 0 ? void 0 : _a.push({
                type: log.op,
                // @ts-ignore
                from: log.contract,
        ...
        if (log.depth == callstack.length - 1) {
            ...
            if (call._gasIn !== undefined && call._gasCost !== undefined) {
                if (call.type == "CREATE" || call.type == "CREATE2") {
                    ...
                    if (ret !== ethers_1.ethers.constants.HashZero) {
                    ...
                    if (call.gas !== undefined) {
                        call.gasUsed =
                            "0x" +
                                (+call._gasIn - +call._gasCost + +call.gas - log.gas).toString(16);
                    }
                    var ret = log.stack[0];
                    if (ret !== ethers_1.ethers.constants.HashZero &&
            ...
            if (left !== 0) {
                ...
                (_b = callstack[left - 1].calls) === null || _b === void 0 ? void 0 : _b.push(call);
            }
        }
        //
        //
...
//   )
// )
function bytes32ToBytes20(input) {
    if (input.slice(0, 2) !== "0x") {
        input = "0x" + input;
    }
    return ethers_1.ethers.utils.hexZeroPad(ethers_1.ethers.utils.hexStripZeros(input), 20);
}
//# sourceMappingURL=debug_traceTransaction.js.map