...
export declare type ChildRequestEthereumAccountsResponse = BaseWeb3Response<AddressString[]>;
export declare function ChildRequestEthereumAccountsResponse(addresses: AddressString[]): RequestEthereumAccountsResponse;
export declare type ArbitraryResponse = BaseWeb3Response<string>;
export declare type Web3Response = ErrorResponse | RequestEthereumAccountsResponse | SignEthereumMessageResponse | SignEthereumTransactionResponse | SubmitEthereumTransactionResponse | EthereumAddressFromSignedMessageResponse | ScanQRCodeResponse | ArbitraryResponse | ChildRequestEthereumAccountsResponse;
export {};
