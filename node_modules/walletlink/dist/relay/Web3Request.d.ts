...
export declare type ChildRequestEthereumAccountsRequest = BaseWeb3Request<Web3Method.childRequestEthereumAccounts, {
    sessionId: string;
...
export declare type Web3Request = RequestEthereumAccountsRequest | SignEthereumMessageRequest | SignEthereumTransactionRequest | SubmitEthereumTransactionRequest | EthereumAddressFromSignedMessageRequest | ScanQRCodeRequest | ArbitraryRequest | ChildRequestEthereumAccountsRequest;
export {};
