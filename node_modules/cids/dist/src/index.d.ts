...
declare class CID {
     ...
     * @returns {CodecNumber}
     */
    get code(): import("multicodec/src/generated-types").CodecNumber;
    /**
...
declare namespace CID {
    export { codecs, SerializedCID, CIDVersion, BaseNameOrCode, CodecName, CodecNumber };
}
type CIDVersion = 0 | 1;
...
import { baseTable as codecs } from "multicodec/src/base-table";
