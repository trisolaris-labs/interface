...
function extractErrors(opts) {
    ...
    try {
        ...
        // file changes.
        existingErrorMap = JSON.parse(fs_extra_1.default.readFileSync(errorMapFilePath, 'utf8'));
    }
    catch (e) {
        existingErrorMap = {};
    }
    ...
    function flush(cb) {
        ...
        fs_extra_1.default.ensureDirSync(constants_1.paths.appErrors);
        // Output messages to ./errors/codes.json
        fs_extra_1.default.writeFileSync(errorMapFilePath, JSON.stringify(invertObject_1.invertObject(existingErrorMap), null, 2) + '\n', 'utf-8');
        // Write the error files, unless they already exist
        fs_extra_1.default.writeFileSync(constants_1.paths.appErrors + '/ErrorDev.js', `
...
export default ErrorDev;      
      `, 'utf-8');
        fs_extra_1.default.writeFileSync(constants_1.paths.appErrors + '/ErrorProd.js', `
