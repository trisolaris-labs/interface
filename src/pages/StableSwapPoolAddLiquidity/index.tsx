...
export default function StableSwapPoolAddLiquidity(
  props: RouteComponentProps<{ stableSwapPoolName?: StableSwapPoolName }>
) {
  ...
  return <StableSwapPoolAddLiquidityImpl {...props} />
}

function StableSwapPoolAddLiquidityImpl({
  match: {
    params: { stableSwapPoolName }
  },
  history
}: RouteComponentProps<{ stableSwapPoolName?: StableSwapPoolName }>) {
  return <div>StableSwapPool Add Liquidity {stableSwapPoolName}</div>
