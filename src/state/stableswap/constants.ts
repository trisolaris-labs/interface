...
export function getTokenForStablePoolType(poolType: StableSwapPoolTypes): Token {
  ...
  } else if (poolType === StableSwapPoolTypes.AURIGAMI_STABLE_DEBT) {
    // return AUUSDC[ChainId.AURORA]

    // 203427876637949*2480/10^16
    return AUUSDC[ChainId.AURORA]
  } else {
...
export const STABLESWAP_POOLS: StableSwapPools = {
  ...
  [StableSwapPoolName.AUUSDC_AUUSDT]: {
    ...
    type: StableSwapPoolTypes.AURIGAMI_STABLE_DEBT,
    route: 'usd',
    isOutdated: false,
    rewardPids: null
  }
