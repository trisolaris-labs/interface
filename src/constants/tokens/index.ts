...
export const UST: { [chainId in ChainId]: Token } = {
  ...
  [ChainId.AURORA]: new Token(ChainId.AURORA, '0x5ce9F0B6AFb36135b5ddBF11705cEB65E634A9dC', 18, 'UST', 'UST')
}
...
export const LUNA: { [chainId in ChainId]: Token } = {
  ...
  [ChainId.AURORA]: new Token(ChainId.AURORA, '0xC4bdd27c33ec7daa6fcfd8532ddB524Bf4038096', 18, 'LUNA', 'LUNA')
}
...
export const AAVE: { [chainId in ChainId]: Token } = {
  ...
  [ChainId.AURORA]: new Token(ChainId.AURORA, '0x0000000000000000000000000000000000000000', 18, 'AAVE', 'AAVE Token')
}
...
export const META: { [chainId in ChainId]: Token } = {
  ...
  [ChainId.AURORA]: new Token(ChainId.AURORA, '0xc21Ff01229e982d7c8b8691163B0A3Cb8F357453', 24, 'META', 'Meta Token')
}
