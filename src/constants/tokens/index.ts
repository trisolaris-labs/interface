...
export const AXLUSDC_USDC_USDT: { [chainId in ChainId]: Token } = {
  [ChainId.POLYGON]: new Token(ChainId.POLYGON, '0x0000000000000000000000000000000000000000', 18, 'axlUSDC-USDC/USDT TLP', 'Trisolaris axlUSDC-USDC/USDT'),
  [ChainId.FUJI]: new Token(ChainId.FUJI, '0x0000000000000000000000000000000000000000', 18, 'axlUSDC-USDC/USDT TLP', 'Trisolaris axlUSDC-USDC/USDT'),
  [ChainId.AVALANCHE]: new Token(ChainId.AVALANCHE, '0x0000000000000000000000000000000000000000', 18, 'axlUSDC-USDC/USDT TLP', 'Trisolaris axlUSDC-USDC/USDT'),
  [ChainId.AURORA]: new Token(ChainId.AURORA, '0x4F13347Fa5eCC4D6a12e7f4F2803616cC0c60E25', 18, 'axlUSDC-USDC/USDT TLP', 'Trisolaris axlUSDC-USDC/USDT'),
}