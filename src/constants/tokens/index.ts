...
export const ABBNB: { [chainId in ChainId]: Token } = {
  ...
  [ChainId.AURORA]: new Token(
    ChainId.AURORA,
    '0xb14674C7264eC7d948B904Aab2c0E0F906F6e762',
    18,
    'abBNB',
    'BNB - Allbridge'
  )
...
export const USDC_USDC_E_TLP: { [chainId in ChainId]: Token } = {
  ...
  [ChainId.AURORA]: new Token(
    ChainId.AURORA,
    '0x19e91C9b155D2A8B47B74e9e100f28355AC13879',
    18,
    'USDC/USDC.e TLP',
    'Trisolaris USDC/USDC.e'
  )
